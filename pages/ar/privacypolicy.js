      ...
      <Layout>
        <div className="container-for-content-pages border-[1px] border-[#f9f9f9] px-[24px] pb-[25px] ">
          ...
          <div className="fal px-[20px] md:p-0">
            ...
            <p className="fal text-[#6b6e73] text-[15px] leading-[28px] tracking-[0.5px] pt-[15px]">
              ‌د. تحكم شروط الخدمة هذه (&#34;الشروط &#34;، &#34;شروط
              الخدمة&#34;) استخدامك لموقعنا/تطبيقنا الموجود على
              (&#34;الخدمة&#34; معا أو بشكل فردي) التي تديرها Katwalk. تحكم
              سياسة الخصوصية أيضا استخدامك لخدمتنا وتشرح كيف نقوم بجمع وحماية
              وكشف المعلومات التي تنتج عن استخدامك لصفحات الويب الخاصة بنا
            </p>
            <p className="fal text-[#6b6e73] text-[15px] leading-[28px] tracking-[0.5px] pt-[15px]">
              ‌و. تتضمن اتفاقيتك معنا هذه الشروط وسياسة الخصوصية الخاصة بنا
              (&#34;الاتفاقية&#34;). أنت تقر بأنك قد قرأت وفهمت الاتفاقية وتوافق
              على الالتزام بها. ‌ز. لا يجوز لك استخدام الخدمة إذا كنت لا توافق
              على الاتفاقية أو لا تستطيع الامتثال لها، و حتى نتمكن من محاولة
              إيجاد حل، الرجاء مراسلتنا عبر البريد الالكتروني{" "}
            ...
            <p className="fal text-[#6b6e73] text-[15px] leading-[28px] tracking-[0.5px] pt-[15px]">
              إذا كنت قد تلقيت طلبك وكان تالفًا أو غير صحيح، فسيكون طلبك مؤهلًا
              للاسترجاع المجاني عن طريق زيارة{" "}
              <a href="katwalk.sa/contact">katwalk.sa/contact</a> واختيار طريقة
              الاتصال المفضلة لديك وذلك خلال 7 أيام من استلام الطلب
            </p>
            ...
            <ul className="fal list-disc ml-[15px] mt-[15px]">
              <li className="fal text-[#6b6e73] text-[15px] leading-[28px] tracking-[0.5px]">
                جميع أسعارنا شاملة لضريبة القيمة المضافة المطبقة في المملكة
                العربية السعودية.
              </li>
              <li className="fal text-[#6b6e73] text-[15px] leading-[28px] tracking-[0.5px]">
                يتم عرض جميع أسعارنا بالريال السعودي.
              ...
              <li className="fal text-[#6b6e73] text-[15px] leading-[28px] tracking-[0.5px]">
                إذا كنت تتسوق خارج المملكة العربية السعودية، فأنت مسؤول عن معرفة
                أسعار صرف العملات المطبقة
              </li>
              <li className="fal text-[#6b6e73] text-[15px] leading-[28px] tracking-[0.5px]">
                يرجى ملاحظة أننا نبذل قصارى جهدنا لتوفير طرق دفع مريحة. إذا
                واجهت أي أخطاء لطلبك، يرجى زيارة{" "}
                <a href="katwalk.sa/contact">katwalk.sa/contact</a>
              </li>
            </ul>
