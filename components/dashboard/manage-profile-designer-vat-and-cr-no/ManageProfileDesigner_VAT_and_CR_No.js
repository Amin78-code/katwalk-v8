...
function ManageProfileDesigner_VAT_and_CR_No({ data, title, handleChangeDesigner,saveData_VAT_and_CR }) {
        ...
        >
          ...
          <div
                      ...
                      <div className="w-[100%] px-0     lg:px-[15px] flex flex-col      lg:flex-row">
                        ...
                        >
                          <input
                            ...
                            value={data[0].value}
                            placeholder={
                              data[0].placeHolder ? data[0].placeHolder : ""
                            }
                          ...
                          >
                            <div className="relative">
                              <input
                                ...
                                onChange={() =>
                                  disablePayment("togglePayment_VAT")
                                }
                              />
                      ...
                      <div className="w-[100%] px-0     lg:px-[15px] flex flex-col      lg:flex-row">
                        ...
                        >
                          <input
                            ...
                            value={data[1].value}
                            placeholder={
                              data[1].placeHolder ? data[1].placeHolder : ""
                            }
                            id={"paymentMethod_VAT"}
            ...
            <div className="flex justify-end">
              <button onClick={()=> saveData_VAT_and_CR()} className="light-brown-btn ffr text-[0.875rem] text-[#fff] h-[40px] leading-[40px] tracking-[0.5px] uppercase bg-[#c83e27] block px-[15px] m-[.25rem]">
                save
              </button>
            </div>
          </CardBody>
