            ...
            <div className="fwr flex mb-[1rem] flex-col      lg:flex-row">
              ...
              <div className="w-[100%] px-0     lg:px-[15px] flex flex-col      lg:flex-row">
                <div
                  ...
                  } w-[100%] h-[44px] relative before:w-[100%] before:h-[100%] before:left-0 before:top-0 before:bg-[#ffffffa6]          before:absolute before:w-[0] before:h-[0] before:border-[4px] before:border-t-[#b7b7b7] before:border-l-[transparent] before:border-r-[transparent] before:border-b-[transparent] before:top-[18px] before:right-[10px]`}
                >
                  <input
                    type="text"
                    className={`
                    admin-input w-[100%] h-[44px] fwl text-[#495057] text-[1rem] bg-[#fff] border-[1px] border-[#ced4da] rounded-[.25rem] py-[0.375rem] px-[0.75rem]  `}
                    value={data[0].value}
                  ...
                  >
                    <div className="relative">
                      <input
                        ...
                        // {value.status} is se checked unchecked set karna he
                        // onChange={() => disablePayment("togglePayment_CR")}
                      />
                      <div className="block bg-[#e8ebf1] w-[40px] h-[23px] rounded-full"></div>
                      <div className="dot absolute left-[2px] top-[2.5px] bg-white w-[17px] h-[17px] rounded-full transition"></div>
                    </div>
