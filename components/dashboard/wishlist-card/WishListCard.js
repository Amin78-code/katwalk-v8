...
function WishListCard({ data }) {
  return (
    <div className="w-[49.4%] lg:w-[32.4%] mb-[0.5rem]">
      <TitleAndTableCard>
        <div className="py-[10px] sm:py-[20px] px-[10px] sm:px-[25px]">
          <span className="image_container">
            <Image src={data.img} alt="image" />
          </span>
          <div>
            <h5 className="fwr font-[600] text-[0.875rem] text-[#1b1b28] mt-[23px] overflow-hidden overflow-ellipsis whitespace-nowrap">
              {data.name}
            </h5>
        ...
        <div className="py-[10px] sm:py-[12px] px-[10px] sm:px-[25px] border-t-[1px] border-[#ebedf2]">
